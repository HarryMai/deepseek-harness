...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Restore one active recycle-bin entry through the legacy archive command. Cleared and expired entries remain archived; the product recycle-bin page uses its confirmation-gated methods instead.',
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: 'unarchiveSession(sessionId: SessionId): Promise<void>',
        description: 'Restore one active recycle-bin entry through the legacy archive command. Cleared and expired entries remain archived; user-visible recovery uses the confirmed recycle-bin methods instead.',
        parameters: [{ name: 'sessionId', description: 'Session to unarchive.' }],
      },
      {

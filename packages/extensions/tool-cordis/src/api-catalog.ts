  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Restore one active recycle-bin entry through the legacy command. Cleared and expired entries remain archived.',
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Unarchive one recoverable Session through the legacy compatibility command. A cleared or expired archive remains archived and its tombstone is kept; only an active recycle-bin entry can be restored by this unconfirmed verb.',
        parameters: [{ name: 'sessionId', description: 'The recoverable Session to unarchive.' }],
        returns: 'resolution after durability.',
      },
      {

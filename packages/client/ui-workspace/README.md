...
- **No Session deletion, and recycle-bin recovery is bounded** — sessions can be archived but never deleted; the Recycle Bin Settings section restores only active entries, while clearing or expiry keeps the Session hidden and its history intact.

...
export interface WorkspaceArchiveSessionRequest {
   ...
   * as `workspace/session-active`. The archive is written before the stop
   * requests are dispatched; the response waits until each request is issued,
   * not until the work settles.
   */

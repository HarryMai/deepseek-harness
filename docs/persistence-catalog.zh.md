...
| `id` | 必需 | `string` |
| `role` | 必需 | `"developer"` |
| `source` | 必需 | [`MessageSource`](#persistence-type-sha256-87a8979602bd7cfc8f70d3743b40cf8b25bde01786b056bdec8722b08c8a7154) |

消息源兼容策略：`source` — `session-source-attribution` v1; `session.developer-message.source`; `kind`; `preserve`.

仅表示归属的新增 kind：`tmux-context`, `tool-cordis`.
...
| `tool-cordis` | `"catalog"` | 无 | [`{ kind: "tool-cordis", form: "catalog" }`](#persistence-type-sha256-9ce58cdb66082e7bf058031a2de72c6df0f1197727671cf82523403c5517625a) |
| `tool-cordis` | `"instructions"` | 无 | [`{ kind: "tool-cordis", form: "instructions" }`](#persistence-type-sha256-7d82e01910244b844eb931a6ca3af13ec30f63c17026dc02555947e23ebaf220) |
...
| `tool-cordis` | `"recall"` | 无 | [`{ kind: "tool-cordis", form: "recall" }`](#persistence-type-sha256-af776091d1ec0b076b3b20946bce950e228ca1a692410d207b8d3c80ddb2a927) |
| `tool-cordis` | `"relay"` | 无 | [`{ kind: "tool-cordis", form: "relay" }`](#persistence-type-sha256-0ddadf0cf6bf21d7103c6460908cc92b63b333972f5d692d4db1021871f6a238) |
...
| `tool-cordis` | 未声明 | 无 | [`{ kind: "tool-cordis" }`](#persistence-type-sha256-6aa508c7542f5fa3bb3be1e9a29bbed69e42ea6af26dfd64d24f5629cda49e08) |
...
[`Message`](#persistence-type-sha256-4c81640686cb32154220720757e3cbbecaad73a11562a842ce4d5b5dc5a1b1d6) 的数组。
...
| `maxTokens` | 必需 | `number` |
| `messageSeqs` | 必需 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `messages` | 必需 | [`Message[]`](#persistence-type-sha256-ba7f6a232ff6f9ba9563135a5c98d4077014b908c09808c40e7780b4a72189bf) |
...
[`UserMessage`](#persistence-type-sha256-18027d9dab8eb16212a7c30683f478e2c69569cd4ee8057c262015fa55086f0f) 的数组。
...
|---|---|---|
| `headerSeq` | 可选 | `number` |
| `message` | 必需 | [`DeveloperMessage`](#persistence-type-sha256-b80f59ac616bb2a5904a2c137626b09a2a5595f4bd1339c2c412dfc6154056fe) |
| `step` | 必需 | `number` |
| `turn` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `inserted` | 必需 | [`UserMessage[]`](#persistence-type-sha256-8cbc7b5132f0270ca5c460a1286b2e50a8fbe77c857707e273ff56b8c89772c3) |
| `outcome` | 可选 | `"canceled"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ inserted, outcome?, removedCount?, start, … }`](#persistence-type-sha256-926a6d00cac846afe02dedb0199151c657935fd8933a625b2e329f6a693a26c2) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ headerSeq?, message, step, turn }`](#persistence-type-sha256-174a00969ba0bc72e73b2bcbb34fb7709242454af8a621febdc25e759e050eb8) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`SessionTitleLlmRequestEventData`](#persistence-type-sha256-d2c32d4e4b87631dff14546b0ad5d3799f9aeaeb61fd5c6fd8276754688d508e) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`UserMessage`](#persistence-type-sha256-18027d9dab8eb16212a7c30683f478e2c69569cd4ee8057c262015fa55086f0f) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
